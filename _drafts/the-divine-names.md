...
(s. 50), och då allt vetande utgår från det som existererar
trancscenderar Gud även vetandet (s. 53):
...
benämningar på Gud. Inget namn kan fånga vad Gud är, och därför
måste vi använda olika namn för att komma åt hans olika aspekter.

Dionysios använder ganska sällan ordet "Gud" när han pratar om
...
> therfore known in all things and as distinct from all things.
...
namn just detta -- Gud är existenses kärna och allt som existerar
...
Men Gud är inte endast någon opersonlig kraft. Gud är också ett
stöd för dem som har det svårt. Till de som faller är Gud "the
voice that calls 'Come back!' and it is the power that raises
them up again" (s. 51). Guds källa är
